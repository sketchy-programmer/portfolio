...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="relative flex justify-center items-center c-space section-spacing"
    >
      <Particles
      ...
      >
        <div className="flex flex-col items-start w-full gap-5 mb-10">
          ...
          <p className="font-normal text-neutral-400">
            Whether you're looking to improve your test coverage, build a new
            application, or bring a unique project to life — I'm here to help.
            Reach me at{" "}
            <a
              href="mailto:singh.s.paramvir@gmail.com"
              className="text-lavender hover:underline"
            >
              singh.s.paramvir@gmail.com
            </a>{" "}
            or call{" "}
            <a href="tel:+13657777634" className="text-lavender hover:underline">
              365-777-7634
            </a>
            .
          </p>
